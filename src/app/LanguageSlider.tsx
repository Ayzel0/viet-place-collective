...
export default function LanguageSlider() {
  ...
  return (
    <div className='relative'>
      <div 
        className='flex flex-row w-[115px] h-[60px] bg-medium-jade items-center p-[5px] rounded hover:brightness-75'
        onClick={handleLanguageChange}
      >
        <div className={`w-[50px] h-[50px] bg-bright-jade rounded transition-transform
