        ...
        >
          ...
          <div className='ml-auto'>
            <ul className='flex flex-row gap-10 text-tan text-2xl items-center'>
              ...
              <li>
                <a href='https://givebutter.com/avietplace' target='_blank' className='px-5 py-2.5 rounded-lg bg-mint text-dark-jade hover:bg-pale-yellow transition-all'>{language === 'english' ? 'Donate' : 'Ủng hộ'}</a>
              </li>
              {/* <li>
                <LanguageSlider />
              </li> */}
